 ...
 *             auth_jwt_authenticator?: scalar|Param|null, // Default: "Dimkinthepro\\JwtAuth\\Infrastructure\\Security\\JWTAuthenticator"
 *         },
 *         login_link?: array{
 ...
 *     },
 * }
 * @psalm-type DimkintheproJwtAuthConfig = array{
 *     public_key_path?: scalar|Param|null, // Default: "%kernel.project_dir%/var/dimkinthepro/jwt-auth-bundle/public.pem"
 *     private_key_path?: scalar|Param|null, // Default: "%kernel.project_dir%/var/dimkinthepro/jwt-auth-bundle/private.pem"
 *     passphrase?: scalar|Param|null, // Passphrase for the private key. Must be set explicitly: a generated default would change on every container rebuild and invalidate all issued tokens.
 *     token_ttl?: scalar|Param|null, // Default: 900
 *     algorithm?: scalar|Param|null, // Default: "RS512"
 *     refresh_token_ttl?: scalar|Param|null, // Default: 2592000
 *     refresh_token_length?: scalar|Param|null, // Default: 128
 *     issuer?: scalar|Param|null, // Value of the "iss" claim; the claim is omitted and not validated when null. // Default: null
 *     audience?: scalar|Param|null, // Value of the "aud" claim; the claim is omitted and not validated when null. // Default: null
 *     clock_skew_leeway?: scalar|Param|null, // Tolerated clock skew in seconds when validating "exp", "nbf" and "iat" claims. // Default: 60
 *     token_extractors?: array{ // Enabled extractors are chained.
 *         authorization_header?: array{
 *             enabled?: bool|Param, // Default: true
 *         },
 *         cookie?: array{
 *             enabled?: bool|Param, // Default: false
 *             name?: scalar|Param|null, // Default: "jwt_token"
 *         },
 *         query_parameter?: array{ // For transports without headers (WebSocket, SSE); tokens in URLs leak into access logs.
 *             enabled?: bool|Param, // Default: false
 *             name?: scalar|Param|null, // Default: "jwt_token"
 *         },
 *         split_cookie?: array{ // Token split into two cookies: "header.payload" (JS-readable) and signature (HttpOnly).
 *             enabled?: bool|Param, // Default: false
 *             payload_cookie_name?: scalar|Param|null, // Default: "jwt_hp"
 *             signature_cookie_name?: scalar|Param|null, // Default: "jwt_sig"
 *         },
 *     },
 *     blocklist?: array{ // Instant access token revocation by the "sid" claim; costs one cache lookup per authenticated request.
 *         enabled?: bool|Param, // Default: false
 *         cache_pool?: scalar|Param|null, // PSR-6 cache pool service id used as the blocklist storage. // Default: "cache.app"
 *     },
 * }
 ...
 *     dimkinthepro_jwt_auth?: DimkintheproJwtAuthConfig,
 *     "when@test"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
